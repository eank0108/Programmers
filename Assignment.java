...
class Car{
    ...
    //오류 로그 - private ArrayList<String> busNumberArray; 라고선언해서 finished with non-zero exit value 1 java error 오류 난듯??  private ArrayList<String> busNumberArray  = new ArrayList<>(); 선언하니 없어짐.
    // static(정적변수) 선언을 하면 메모리에 저장됨. 메모리 할당을 딱 한번만 하기 때문에 같은 곳의 메모리 주소만을 바라봄, 공유 개념 
